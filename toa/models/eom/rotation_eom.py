...
class RotationEOM(om.ExplicitComponent):
    ...
    def setup_partials(self):
        ...
        self.declare_partials(of='dXdt:v', wrt='q')
        ...
        self.declare_partials(of='dXdt:q', wrt='thrust')
        self.declare_partials(of='dXdt:q', wrt='lift')
        self.declare_partials(of='dXdt:q', wrt='drag')
        self.declare_partials(of='dXdt:q', wrt='moment')
        self.declare_partials(of='dXdt:q', wrt='V')
        self.declare_partials(of='dXdt:q', wrt='mass')
        self.declare_partials(of='dXdt:q', wrt='alpha')
        self.declare_partials(of='dXdt:q', wrt='q')
        self.declare_partials(of='dXdt:q', wrt='grav')
        self.declare_partials(of='dXdt:q', wrt='rw_slope')
        ...
        self.declare_partials(of='rf_mainwheel', wrt='q')
