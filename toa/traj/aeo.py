...
def run_takeoff(airplane, runway, flap_angle=0.0, wind_speed=0.0):
    ...
    rotation.add_state(name='h', units='m', rate_source='rotation_eom.h_dot',
                       targets=['mlg_pos.h', 'aero.ground_effect.h'], fix_initial=True, fix_final=False, ref=10,
                       defect_ref=10)
    ...
    transition.add_state(name='h', units='m', rate_source='transition_eom.h_dot',
                         targets=['mlg_pos.h', 'aero.ground_effect.h'], fix_initial=False, fix_final=False, ref=10,
                         defect_ref=10)
    ...
    # transition.add_objective('obj_cmp.obj', loc='final', scaler=-1)
