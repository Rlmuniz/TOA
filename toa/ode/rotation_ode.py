...
class RotationODE(om.Group):
    ...
    def setup(self):
        ...
        assumptions.add_output('gam', val=np.repeat(0.0, nn), units='rad', desc='Flight path angle')
        ...
        self.connect('assumptions.gam', 'alpha_comp.gam')
        ...
        self.connect('alpha_comp.alpha', 'rotation_eom.alpha')
